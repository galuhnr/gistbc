...
<div class="row pr-3 pb-3">
    <div class="col-6">
        <h5>Pemetaan Tingkat Kerawanan Penyakit TBC Tahun 2018</h5>
    </div>
    <div class="col-6 d-flex justify-content-end">
        <select id="selectMap">
            ...
            <option value="3" href="{{route('peta2018')}}" selected>2018</option>
...
<script type="text/javascript">
    ...
    var api = 'http://192.168.43.133:8000/api/cluster2018';
    var dataCluster=[];
    var geojson=[];
    getData();
