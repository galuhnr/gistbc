...
public class InfoPengobatan extends AppCompatActivity {

    String TAG = "InfoPengobatan";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.info_pengobatan);
    ...
    public void getData() {
        ...
        call.enqueue(new Callback<List<ModelInfo>>() {
            ...
            public void onResponse(Call<List<ModelInfo>> call, Response<List<ModelInfo>> response) {
                isi_info.setText(response.body().get(4).getIsi_info());
            }
