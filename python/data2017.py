...
#perintah sql
cur.execute("SELECT jml_faskes, jml_kasus, jml_rumahts, jml_kp FROM data_kriterias where tahun_id=1 order by kecamatan_id asc;")
...
# data nama kecamatan
cur.execute("SELECT data_kriterias.tahun_id, data_kriterias.kecamatan_id, kecamatans.nama_kecamatan from data_kriterias inner join kecamatans on data_kriterias.kecamatan_id = kecamatans.id_kecamatan where data_kriterias.tahun_id=1 order by data_kriterias.kecamatan_id asc;")
